...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif msg.text in ["Assslamualaikum"]:
                ki.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُهُ")
                kk.sendText(msg.to,"Wa'alaikumsalam Wr.Wb")
            elif msg.text in ["Assalamualaikum wr.wb"]:
                ki.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُرَحْمَةُ اللهِ وَبَرَكَاتُهُ")
                kk.sendText(msg.to,"Wa'alaikumsallam.Wr,Wb")
            elif "Assalamualaikum wr,wb" in msg.text:
              if msg.from_ in owner:
                ki.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُهُُ")
                kk.sendText(msg.to,"Wa'alaikumsalam wr,wb")
                ki.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُهُ")
                kk.sendText(msg.to,"Wa'alaikumsallam.Wr,Wb")
                if msg.toType == 2:
